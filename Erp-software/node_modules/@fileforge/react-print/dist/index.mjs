...
var require_guards = __commonJS({
  "node_modules/postcss-selector-parser/dist/selectors/guards.js"(exports) {
    ...
    exports.isPseudoClass = isPseudoClass2;
...
function transformTransition(e4, n4, o5) {
  const { prop: t5, value: i5 } = e4, l2 = (0, import_postcss_value_parser3.default)(i5), a3 = [];
  let s2 = [];
  l2.nodes.forEach((r5) => {
  ...
  const c2 = import_postcss_value_parser3.default.stringify(d3);
...
function doTransform(e4, n4, o5) {
  const { prop: t5, value: i5 } = e4, l2 = (0, import_postcss_value_parser3.default)(i5);
  l2.nodes.forEach((r5) => {
    if ("word" === r5.type) {
...
function prepareTransforms(e4, t5, i5, l2, a3) {
  return { "caption-side": (d3 = e4, (r5) => doTransform(r5, Object.values(o4), d3)), "text-align": e4.inlineIsHorizontal ? (s2 = e4.inline, (e5) => {
    const { prop: o5, value: t6 } = e5, i6 = (0, import_postcss_value_parser3.default)(t6), [l3, a4] = s2;
    i6.nodes.forEach((r5) => {
      if ("word" === r5.type) {
...
var import_postcss_value_parser3, e3, n3, o4, t4, i4, creator2;
var init_dist = __esm({
  "node_modules/postcss-logical/dist/index.mjs"() {
    "use strict";
    init_shim();
    import_postcss_value_parser3 = __toESM(require_lib(), 1);
    !function(r5) {
    ...
    creator2 = (r5) => {
      ...
      if (!Object.values(i4).every((r6) => [o5, l2, a3, s2].includes(r6)))
      ...
      }, d3 = prepareTransforms({ block: [o5, l2], inline: [a3, s2], inlineIsHorizontal: [t4.LeftToRight, t4.RightToLeft].includes(e4.inlineDirection) }, o5, l2, a3, s2);
...
var PageBreak = (props) => {
  return /* @__PURE__ */ React.createElement("div", { ...props, className: `onedoc-page-break ${props?.className || ""}` });
};
var NoBreak = (props) => {
...
var allowedEntities = {
  ...
  "&gt;": ">",
  ":where": ":is"
  // This may introduce specificity issues, but there is no workaround supported by the engine.
};
var CSS = ({ children }) => {
  ...
  return /* @__PURE__ */ React2.createElement("style", { dangerouslySetInnerHTML: { __html: contents } });
};
var Font = ({ url: url2 }) => {
  return /* @__PURE__ */ React2.createElement(CSS, null, `@import url('${url2}');`);
};
var Margins = ({
  pageRatio,
  top,
  ...
  return /* @__PURE__ */ React2.createElement(CSS, null, `@page {size: ${pageRatio};margin-top:${top}px;margin-right:${right}px;margin-left:${left}px;margin-bottom:${bottom}px;`);
};
var __docConfig = {
  name: "CSS",
    ...
    CSS: {
      ...
      examples: {
        default: {
          ...
          template: /* @__PURE__ */ React2.createElement(CSS, null, `@page { size: a4 landscape; }`)
        }
      }
    },
    Font: {
      ...
      examples: {
        default: {
          ...
          template: /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(Font, { url: "https://fonts.googleapis.com/css2?family=Roboto:wght@300&display=swap" }), /* @__PURE__ */ React2.createElement("p", { style: { fontFamily: "Roboto, sans-serif" } }, "This text uses the Roboto Light font."))
        }
      }
    },
    Margins: {
      ...
      examples: {
        default: {
          ...
          template: /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(CSS, null, `body{background-color:lightblue}`), /* @__PURE__ */ React2.createElement(
            Margins,
            {
              pageRatio: "A4",
              top: "100",
          ...
          ), /* @__PURE__ */ React2.createElement("div", null, "Hello world!"))
        }
      }
    }
  }
...
var PageNumber = ({
  ...
  return /* @__PURE__ */ React3.createElement(React3.Fragment, null, /* @__PURE__ */ React3.createElement(CSS, null, `
.onedoc-page-number-${counterStyle}:before {
  content: counter(page, ${counterStyle});
}
        `), /* @__PURE__ */ React3.createElement("span", { className: `onedoc-page-number-${counterStyle}` }));
};
var PagesNumber = ({
  counterStyle = "decimal"
}) => {
...
.onedoc-pages-number-${counterStyle}:before {
  content: counter(pages, ${counterStyle});
        ...
        `), /* @__PURE__ */ React3.createElement("span", { className: `onedoc-pages-number-${counterStyle}` }));
};
...
var __docConfig2 = {
  ...
  components: {
    PageNumber: {
      ...
      examples: {
        default: {
          template: /* @__PURE__ */ React3.createElement(PageNumber, { counterStyle: "decimal" })
        },
        customStyle: {
          description: "You can use a custom CSS counter-style, by passing a known name or a custom counter style.",
          template: /* @__PURE__ */ React3.createElement(PageNumber, { counterStyle: "lower-roman" })
        }
      }
    },
    PagesNumber: {
      ...
      examples: {
        default: {
          imports: ["PageNumber"],
          template: /* @__PURE__ */ React3.createElement(React3.Fragment, null, /* @__PURE__ */ React3.createElement(PageNumber, { counterStyle: "decimal" }), " of ", /* @__PURE__ */ React3.createElement(PagesNumber, { counterStyle: "decimal" }))
        }
      }
    },
    RunningH1: {
      ...
      examples: {
        default: {
          ...
          template: /* @__PURE__ */ React3.createElement(React3.Fragment, null, /* @__PURE__ */ React3.createElement(PageTop, { style: { paddingTop: "1rem" } }, /* @__PURE__ */ React3.createElement(RunningH1, null)), /* @__PURE__ */ React3.createElement("h1", null, "Heading of level 1"))
        }
      }
    },
    RunningH2: {
...
var Footnote = ({
  ...
  return /* @__PURE__ */ React4.createElement("span", { className: "onedoc-footnote text-left text-xs font-normal", ...props }, children);
};
...
function conditionsFromValue(a3, t5 = false) {
  const i5 = [], o5 = r.filter((e4) => a3.includes(e4.sniff));
  let s2 = false;
  try {
...
var creator = () => ({ postcssPlugin: "postcss-progressive-custom-properties", prepare() {
  ...
  return { OnceExit: (a3, { postcss: r5 }) => {
    a3.walkDecls((a4) => {
      ...
      if (!a4.variable && !t.test(a4.value))
        return;
      if (i.test(a4.value))
        return;
      if (o.test(a4.value))
...
var r2 = Object.values(e2);
function isToken(e4) {
  return !!Array.isArray(e4) && (!(e4.length < 4) && (!!r2.includes(e4[0]) && ("string" == typeof e4[1] && ("number" == typeof e4[2] && "number" == typeof e4[3]))));
}
...
function checkIfTwoCodePointsStartAComment(e4) {
  return e4.codePointSource[e4.cursor] === B && e4.codePointSource[e4.cursor + 1] === i2;
}
...
function consumeComment(n4, o5) {
  for (o5.advanceCodePoint(2); ; ) {
    ...
    if (e4 === i2 && (void 0 !== o5.codePointSource[o5.cursor] && o5.codePointSource[o5.cursor] === B)) {
      o5.advanceCodePoint();
      break;
    }
  }
...
function consumeHashToken(n4, r5) {
  if (r5.advanceCodePoint(), void 0 !== r5.codePointSource[r5.cursor] && (isIdentCodePoint(r5.codePointSource[r5.cursor]) || checkIfTwoCodePointsAreAValidEscape(r5))) {
    let t5 = o2.Unrestricted;
    checkIfThreeCodePointsWouldStartAnIdentSequence(0, r5) && (t5 = o2.ID);
...
function consumeNumber(e4, o5) {
  ...
  if (o5.codePointSource[o5.cursor] === l && isDigitCodePoint(o5.codePointSource[o5.cursor + 1]))
    for (o5.advanceCodePoint(2), r5 = n.Number; isDigitCodePoint(o5.codePointSource[o5.cursor]); )
      o5.advanceCodePoint();
  if (o5.codePointSource[o5.cursor] === v || o5.codePointSource[o5.cursor] === m) {
    ...
    for (r5 = n.Number; isDigitCodePoint(o5.codePointSource[o5.cursor]); )
      o5.advanceCodePoint();
  }
  return r5;
}
function consumeNumericToken(n4, o5) {
  ...
  if (checkIfThreeCodePointsWouldStartAnIdentSequence(0, o5)) {
    ...
    return [e2.Dimension, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, { value: i5, signCharacter: r5, type: t5, unit: String.fromCodePoint(...c2) }];
  }
  return o5.codePointSource[o5.cursor] === L ? (o5.advanceCodePoint(), [e2.Percentage, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, { value: i5, signCharacter: r5 }]) : [e2.Number, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, { value: i5, signCharacter: r5, type: t5 }];
}
...
function consumeStringToken(n4, o5) {
  ...
  for (; ; ) {
    ...
    if (false === i5)
      return n4.onParseError(new ParseError("Unexpected EOF while consuming a string token.", o5.representationStart, o5.representationEnd, ["4.3.5. Consume a string token", "Unexpected EOF"])), [e2.String, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, { value: r5 }];
    if (isNewLine(i5))
      return n4.onParseError(new ParseError("Unexpected newline while consuming a string token.", o5.representationStart, o5.representationEnd, ["4.3.5. Consume a string token", "Unexpected newline"])), o5.unreadCodePoint(), [e2.BadString, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, void 0];
    if (i5 === t5)
...
function consumeUrlToken(n4, o5) {
  ...
  for (; ; ) {
    if (void 0 === o5.codePointSource[o5.cursor])
      return n4.onParseError(new ParseError("Unexpected EOF while consuming a url token.", o5.representationStart, o5.representationEnd, ["4.3.6. Consume a url token", "Unexpected EOF"])), [e2.URL, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, { value: r5 }];
    ...
    if (isWhitespace(o5.codePointSource[o5.cursor])) {
      for (o5.advanceCodePoint(); isWhitespace(o5.codePointSource[o5.cursor]); )
        o5.advanceCodePoint();
      return void 0 === o5.codePointSource[o5.cursor] ? (n4.onParseError(new ParseError("Unexpected EOF while consuming a url token.", o5.representationStart, o5.representationEnd, ["4.3.6. Consume a url token", "Consume as much whitespace as possible", "Unexpected EOF"])), [e2.URL, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, { value: r5 }]) : o5.codePointSource[o5.cursor] === b ? (o5.advanceCodePoint(), [e2.URL, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, { value: r5 }]) : (consumeBadURL(n4, o5), [e2.BadURL, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, void 0]);
    }
    if (o5.codePointSource[o5.cursor] === y || o5.codePointSource[o5.cursor] === t2 || o5.codePointSource[o5.cursor] === k || ((i5 = o5.codePointSource[o5.cursor]) === U || i5 === p2 || A <= i5 && i5 <= c || V <= i5 && i5 <= E))
...
function consumeUnicodeRangeToken(n4, o5) {
  ...
  return [e2.UnicodeRange, o5.source.slice(o5.representationStart, o5.representationEnd + 1), o5.representationStart, o5.representationEnd, { startOfRange: i5, endOfRange: c2 }];
}
...
function tokenizer(n4, o5) {
  ...
  return { nextToken: function nextToken() {
    ...
    switch (n5) {
      case d:
        return c2.advanceCodePoint(), [e2.Comma, ",", c2.representationStart, c2.representationEnd, void 0];
      case u:
        return c2.advanceCodePoint(), [e2.Colon, ":", c2.representationStart, c2.representationEnd, void 0];
      case H:
        return c2.advanceCodePoint(), [e2.Semicolon, ";", c2.representationStart, c2.representationEnd, void 0];
      case k:
        return c2.advanceCodePoint(), [e2.OpenParen, "(", c2.representationStart, c2.representationEnd, void 0];
      case b:
        return c2.advanceCodePoint(), [e2.CloseParen, ")", c2.representationStart, c2.representationEnd, void 0];
      case I:
        return c2.advanceCodePoint(), [e2.OpenSquare, "[", c2.representationStart, c2.representationEnd, void 0];
      case F:
        return c2.advanceCodePoint(), [e2.CloseSquare, "]", c2.representationStart, c2.representationEnd, void 0];
      case g:
        return c2.advanceCodePoint(), [e2.OpenCurly, "{", c2.representationStart, c2.representationEnd, void 0];
      case N:
        return c2.advanceCodePoint(), [e2.CloseCurly, "}", c2.representationStart, c2.representationEnd, void 0];
      case t2:
      case y:
      ...
      case x:
      case l:
        return checkIfThreeCodePointsWouldStartANumber(c2) ? consumeNumericToken(p3, c2) : (c2.advanceCodePoint(), [e2.Delim, c2.source[c2.representationStart], c2.representationStart, c2.representationEnd, { value: c2.source[c2.representationStart] }]);
      case O:
      case s:
      case C:
      case a2:
      ...
      case h:
        return checkIfThreeCodePointsWouldStartANumber(c2) ? consumeNumericToken(p3, c2) : checkIfThreeCodePointsWouldStartCDC(c2) ? (c2.advanceCodePoint(3), [e2.CDC, "-->", c2.representationStart, c2.representationEnd, void 0]) : checkIfThreeCodePointsWouldStartAnIdentSequence(0, c2) ? consumeIdentLikeToken(p3, c2) : (c2.advanceCodePoint(), [e2.Delim, "-", c2.representationStart, c2.representationEnd, { value: "-" }]);
      case T:
        return checkIfFourCodePointsWouldStartCDO(c2) ? (c2.advanceCodePoint(4), [e2.CDO, "<!--", c2.representationStart, c2.representationEnd, void 0]) : (c2.advanceCodePoint(), [e2.Delim, "<", c2.representationStart, c2.representationEnd, { value: "<" }]);
      case P:
        if (c2.advanceCodePoint(), checkIfThreeCodePointsWouldStartAnIdentSequence(0, c2)) {
          const n6 = consumeIdentSequence(p3, c2);
          return [e2.AtKeyword, c2.source.slice(c2.representationStart, c2.representationEnd + 1), c2.representationStart, c2.representationEnd, { value: String.fromCodePoint(...n6) }];
        }
        return [e2.Delim, "@", c2.representationStart, c2.representationEnd, { value: "@" }];
      case W:
        return checkIfTwoCodePointsAreAValidEscape(c2) ? consumeIdentLikeToken(p3, c2) : (c2.advanceCodePoint(), p3.onParseError(new ParseError('Invalid escape sequence after "\\"', c2.representationStart, c2.representationEnd, ["4.3.1. Consume a token", "U+005C REVERSE SOLIDUS (\\)", "The input stream does not start with a valid escape sequence"])), [e2.Delim, "\\", c2.representationStart, c2.representationEnd, { value: "\\" }]);
    }
    return c2.advanceCodePoint(), [e2.Delim, c2.source[c2.representationStart], c2.representationStart, c2.representationEnd, { value: c2.source[c2.representationStart] }];
...
function consumeAllCommentsAndWhitespace(n4, t5) {
  ...
  let s2 = 0;
  for (; ; )
    if (t5[s2][0] !== e2.Whitespace) {
      if (t5[s2][0] !== e2.Comment)
...
function parseCommaSeparatedListOfComponentValues(n4, t5) {
  ...
  if (0 === n4.length)
    return [];
  s2[s2.length - 1][0] !== e2.EOF && s2.push([e2.EOF, "", s2[s2.length - 1][2], s2[s2.length - 1][3], void 0]);
  const i5 = [];
  let r5 = [], a3 = 0;
  for (; ; ) {
    if (!s2[a3] || s2[a3][0] === e2.EOF)
...
function convertUnit(e4, n4) {
  ...
  return [e2.Dimension, a3.toString() + e4[4].unit, n4[2], n4[3], { value: a3, unit: e4[4].unit, type: Number.isInteger(a3) ? n.Integer : n.Number }];
}
function toCanonicalUnit(e4) {
  ...
  return [e2.Dimension, i5.toString() + t5, e4[2], e4[3], { value: i5, unit: t5, type: Number.isInteger(i5) ? n.Integer : n.Number }];
}
function addition(n4) {
  ...
  if (t5[0] === e2.Number && r5[0] === e2.Number) {
    ...
    return new TokenNode([e2.Number, n5.toString(), t5[2], r5[3], { value: n5, type: t5[4].type === n.Integer && r5[4].type === n.Integer ? n.Integer : n.Number }]);
  }
  ...
  if (t5[0] === e2.Dimension && r5[0] === e2.Dimension && (r5 = convertUnit(t5, r5), toLowerCaseAZ(t5[4].unit) === toLowerCaseAZ(r5[4].unit))) {
    const n5 = t5[4].value + r5[4].value;
    return new TokenNode([e2.Dimension, n5.toString() + t5[4].unit, t5[2], r5[3], { value: n5, type: t5[4].type === n.Integer && r5[4].type === n.Integer ? n.Integer : n.Number, unit: t5[4].unit }]);
  }
  return -1;
}
function division(n4) {
  ...
  if (t5[0] === e2.Number && r5[0] === e2.Number) {
    const n5 = t5[4].value / r5[4].value;
    return new TokenNode([e2.Number, n5.toString(), t5[2], r5[3], { value: n5, type: Number.isInteger(n5) ? n.Integer : n.Number }]);
  }
  ...
  if (t5[0] === e2.Dimension && r5[0] === e2.Number) {
    const n5 = t5[4].value / r5[4].value;
    return new TokenNode([e2.Dimension, n5.toString() + t5[4].unit, t5[2], r5[3], { value: n5, type: Number.isInteger(n5) ? n.Integer : n.Number, unit: t5[4].unit }]);
  }
  return -1;
}
...
function multiplication(n4) {
  ...
  if (t5[0] === e2.Number && r5[0] === e2.Dimension) {
    const n5 = t5[4].value * r5[4].value;
    return new TokenNode([e2.Dimension, n5.toString() + r5[4].unit, t5[2], r5[3], { value: n5, type: t5[4].type === n.Integer && r5[4].type === n.Integer ? n.Integer : n.Number, unit: r5[4].unit }]);
  }
  return -1;
}
function resolveGlobalsAndConstants(t5, r5) {
  for (let u3 = 0; u3 < t5.length; u3++) {
    ...
    switch (o5) {
      case "e":
        t5.splice(u3, 1, new TokenNode([e2.Number, Math.E.toString(), a3[2], a3[3], { value: Math.E, type: n.Number }]));
        break;
      case "pi":
        t5.splice(u3, 1, new TokenNode([e2.Number, Math.PI.toString(), a3[2], a3[3], { value: Math.PI, type: n.Number }]));
        break;
      case "infinity":
        t5.splice(u3, 1, new TokenNode([e2.Number, "infinity", a3[2], a3[3], { value: 1 / 0, type: n.Number }]));
        break;
      case "-infinity":
        t5.splice(u3, 1, new TokenNode([e2.Number, "-infinity", a3[2], a3[3], { value: -1 / 0, type: n.Number }]));
        break;
      case "nan":
        t5.splice(u3, 1, new TokenNode([e2.Number, "NaN", a3[2], a3[3], { value: Number.NaN, type: n.Number }]));
        break;
      default:
        if (r5.has(o5)) {
          const n4 = r5.get(o5);
...
function dimensionToCalculation(n4, t5, r5) {
  const u3 = n4.tokens();
  return { inputs: [new TokenNode([e2.Dimension, r5.toString() + t5, u3[0][2], u3[u3.length - 1][3], { value: r5, type: Number.isInteger(r5) ? n.Integer : n.Number, unit: t5 }])], operation: unary };
}
...
function numberToCalculation(n4, t5) {
  const r5 = n4.tokens();
  return { inputs: [new TokenNode([e2.Number, t5.toString(), r5[0][2], r5[r5.length - 1][3], { value: t5, type: Number.isInteger(t5) ? n.Integer : n.Number }])], operation: unary };
}
...
var Z = /* @__PURE__ */ new Map([["abs", function abs(e4, n4) {
  ...
  const v2 = solve(calc$1(new FunctionNode([e2.Function, "calc(", -1, -1, { value: "calc" }], [e2.CloseParen, ")", -1, -1, void 0], o5), u3));
  if (-1 === v2)
    return -1;
  const m2 = solve(calc$1(new FunctionNode([e2.Function, "calc(", -1, -1, { value: "calc" }], [e2.CloseParen, ")", -1, -1, void 0], l2), u3));
  if (-1 === m2)
    return -1;
  const f2 = solve(calc$1(new FunctionNode([e2.Function, "calc(", -1, -1, { value: "calc" }], [e2.CloseParen, ")", -1, -1, void 0], c2), u3));
  if (-1 === f2)
    return -1;
  ...
  const l2 = [], c2 = [];
  {
    ...
    for (let t5 = 0; t5 < i5.length; t5++) {
      const r5 = i5[t5];
      if (!o5 && 0 === l2.length && 0 === c2.length && isTokenNode(r5) && r5.value[0] === e2.Ident) {
  ...
  const v2 = solve(calc$1(new FunctionNode([e2.Function, "calc(", -1, -1, { value: "calc" }], [e2.CloseParen, ")", -1, -1, void 0], l2), u3));
  if (-1 === v2)
    return -1;
  const m2 = solve(calc$1(new FunctionNode([e2.Function, "calc(", -1, -1, { value: "calc" }], [e2.CloseParen, ")", -1, -1, void 0], c2), u3));
  if (-1 === m2)
    return -1;
  o5 || (o5 = "nearest");
...
function patchNaN(n4) {
  ...
  if (isFunctionNode(n4))
    return n4;
  const t5 = n4.value;
  return t5[0] !== e2.Number && t5[0] !== e2.Percentage && t5[0] !== e2.Dimension ? n4 : Number.isNaN(t5[4].value) ? t5[0] === e2.Number ? new FunctionNode([e2.Function, "calc(", t5[2], t5[3], { value: "calc" }], [e2.CloseParen, ")", t5[2], t5[3], void 0], [new TokenNode([e2.Ident, "NaN", t5[2], t5[3], { value: "NaN" }])]) : t5[0] === e2.Dimension ? new FunctionNode([e2.Function, "calc(", t5[2], t5[3], { value: "calc" }], [e2.CloseParen, ")", t5[2], t5[3], void 0], [new TokenNode([e2.Ident, "NaN", t5[2], t5[3], { value: "NaN" }]), new WhitespaceNode([[e2.Whitespace, " ", t5[2], t5[3], void 0]]), new TokenNode([e2.Delim, "*", t5[2], t5[3], { value: "*" }]), new WhitespaceNode([[e2.Whitespace, " ", t5[2], t5[3], void 0]]), new TokenNode([e2.Dimension, "1" + t5[4].unit, t5[2], t5[3], { value: 1, type: n.Integer, unit: t5[4].unit }])]) : t5[0] === e2.Percentage ? new FunctionNode([e2.Function, "calc(", t5[2], t5[3], { value: "calc" }], [e2.CloseParen, ")", t5[2], t5[3], void 0], [new TokenNode([e2.Ident, "NaN", t5[2], t5[3], { value: "NaN" }]), new WhitespaceNode([[e2.Whitespace, " ", t5[2], t5[3], void 0]]), new TokenNode([e2.Delim, "*", t5[2], t5[3], { value: "*" }]), new WhitespaceNode([[e2.Whitespace, " ", t5[2], t5[3], void 0]]), new TokenNode([e2.Percentage, "1%", t5[2], t5[3], { value: 1 }])]) : -1 : n4;
}
function patchInfinity(n4) {
  ...
  if (Number.isFinite(t5[4].value))
    return n4;
  let r5 = "";
  return Number.NEGATIVE_INFINITY === t5[4].value && (r5 = "-"), t5[0] === e2.Number ? new FunctionNode([e2.Function, "calc(", t5[2], t5[3], { value: "calc" }], [e2.CloseParen, ")", t5[2], t5[3], void 0], [new TokenNode([e2.Ident, r5 + "infinity", t5[2], t5[3], { value: r5 + "infinity" }])]) : t5[0] === e2.Dimension ? new FunctionNode([e2.Function, "calc(", t5[2], t5[3], { value: "calc" }], [e2.CloseParen, ")", t5[2], t5[3], void 0], [new TokenNode([e2.Ident, r5 + "infinity", t5[2], t5[3], { value: r5 + "infinity" }]), new WhitespaceNode([[e2.Whitespace, " ", t5[2], t5[3], void 0]]), new TokenNode([e2.Delim, "*", t5[2], t5[3], { value: "*" }]), new WhitespaceNode([[e2.Whitespace, " ", t5[2], t5[3], void 0]]), new TokenNode([e2.Dimension, "1" + t5[4].unit, t5[2], t5[3], { value: 1, type: n.Integer, unit: t5[4].unit }])]) : t5[0] === e2.Percentage ? new FunctionNode([e2.Function, "calc(", t5[2], t5[3], { value: "calc" }], [e2.CloseParen, ")", t5[2], t5[3], void 0], [new TokenNode([e2.Ident, r5 + "infinity", t5[2], t5[3], { value: r5 + "infinity" }]), new WhitespaceNode([[e2.Whitespace, " ", t5[2], t5[3], void 0]]), new TokenNode([e2.Delim, "*", t5[2], t5[3], { value: "*" }]), new WhitespaceNode([[e2.Whitespace, " ", t5[2], t5[3], void 0]]), new TokenNode([e2.Percentage, "1%", t5[2], t5[3], { value: 1 }])]) : -1;
}
...
function dummyNumberToken(n4) {
  return [e2.Number, n4.toString(), -1, -1, { value: n4, type: n.Number }];
}
...
function normalize_Color_ChannelValues(n4, r5, o5) {
  if (n4[0] === e2.Ident && "none" === toLowerCaseAZ2(n4[4].value))
    return o5.syntaxFlags.add(ae.HasNoneKeywords), [e2.Number, "none", n4[2], n4[3], { value: NaN, type: n.Number }];
  if (n4[0] === e2.Percentage) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasPercentageValues);
    let t5 = normalize(n4[4].value, 100, -1 / 0, 1 / 0);
    return 3 === r5 && (t5 = normalize(n4[4].value, 100, 0, 1)), [e2.Number, t5.toString(), n4[2], n4[3], { value: t5, type: n.Number }];
  }
  if (n4[0] === e2.Number) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasNumberValues);
    let t5 = normalize(n4[4].value, 1, -1 / 0, 1 / 0);
    return 3 === r5 && (t5 = normalize(n4[4].value, 1, 0, 1)), [e2.Number, t5.toString(), n4[2], n4[3], { value: t5, type: n.Number }];
  }
  return false;
}
...
function color$1(a3, n4) {
  ...
  for (let N3 = 0; N3 < a3.value.length; N3++) {
    ...
    if (isWhitespaceNode(p4) || isCommentNode(p4))
      ...
      if (h3 === r5 && 0 === r5.length && isTokenNode(p4) && p4.value[0] === e2.Ident && oe.has(toLowerCaseAZ2(p4.value[4].value))) {
        if (i5)
          return false;
        ...
        if (!isTokenNode(p4))
          return false;
        if (p4.value[0] === e2.Ident && s2 && s2.has(toLowerCaseAZ2(p4.value[4].value))) {
...
function colorMix(a3, n4) {
  ...
  for (let s2 = 0; s2 < a3.value.length; s2++) {
    ...
    if (!isWhitespaceNode(u3) && !isCommentNode(u3)) {
      ...
      return !(!isTokenNode(u3) || u3.value[0] !== e2.Comma) && (!!o5 && (t5 || l2 ? !!(o5 && t5 && l2 && le.has(o5) && se.has(t5)) && colorMixPolar(o5, t5, colorMixComponents(a3.value.slice(s2 + 1), n4)) : te.has(o5) ? colorMixRectangular(o5, colorMixComponents(a3.value.slice(s2 + 1), n4)) : !!le.has(o5) && colorMixPolar(o5, "shorter", colorMixComponents(a3.value.slice(s2 + 1), n4))));
    }
  }
  return false;
}
  ...
  for (let o6 = 0; o6 < a3.length; o6++) {
    ...
    if (!isWhitespaceNode(s3) && !isCommentNode(s3)) {
      if (!isTokenNode(s3) || s3.value[0] !== e2.Comma) {
        ...
        if (!l2) {
          if (isFunctionNode(s3) && z2.has(toLowerCaseAZ2(s3.getName())) && ([[s3]] = calcFromComponentValues([[s3]], { toCanonicalUnits: true, precision: 100 }), !s3 || !isTokenNode(s3) || (s3.value[0] === e2.Percentage || s3.value[0] === e2.Number || s3.value[0] === e2.Dimension) && Number.isNaN(s3.value[4].value)))
            return false;
...
function normalizeHue(n4) {
  ...
  if (n4[0] === e2.Dimension) {
    ...
    return r5 %= 360, [e2.Number, r5.toString(), n4[2], n4[3], { value: r5, type: n.Number }];
  }
  return false;
}
function normalize_legacy_HSL_ChannelValues(n4, r5, o5) {
  if (0 === r5) {
    ...
    return false !== a3 && (n4[0] === e2.Dimension && o5.syntaxFlags.add(ae.HasDimensionValues), a3);
  }
  if (n4[0] === e2.Percentage) {
  ...
  if (n4[0] === e2.Number) {
    ...
    return 3 === r5 && (o6 = normalize(n4[4].value, 1, 0, 1)), [e2.Number, o6.toString(), n4[2], n4[3], { value: o6, type: n.Number }];
  }
  return false;
}
  ...
  for (let n5 = 0; n5 < a3.value.length; n5++) {
    ...
    if (isWhitespaceNode(o6) || isCommentNode(o6))
      for (; isWhitespaceNode(a3.value[n5 + 1]) || isCommentNode(a3.value[n5 + 1]); )
        n5++;
    else if (b3 === s2 && s2.length && (b3 = u3), b3 === u3 && u3.length && (b3 = i5), isTokenNode(o6) && o6.value[0] === e2.Delim && "/" === o6.value[4].value) {
      if (b3 === c2)
        return false;
      b3 = c2;
    } else {
      ...
      if (b3 === s2 && 0 === s2.length && isTokenNode(o6) && o6.value[0] === e2.Ident && "from" === toLowerCaseAZ2(o6.value[4].value) && "hsla" !== l2 && "rgba" !== l2) {
        if (N2)
          return false;
        for (; isWhitespaceNode(a3.value[n5 + 1]) || isCommentNode(a3.value[n5 + 1]); )
          n5++;
        ...
        if (!isTokenNode(o6))
          return false;
        if (o6.value[0] === e2.Ident && m2 && m2.has(toLowerCaseAZ2(o6.value[4].value))) {
...
function normalize_Lab_ChannelValues(n4, r5, o5) {
  ...
  if (n4[0] === e2.Percentage) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasPercentageValues);
    let t5 = normalize(n4[4].value, 1, 0, 100);
    return 1 === r5 || 2 === r5 ? t5 = normalize(n4[4].value, 0.8, -1 / 0, 1 / 0) : 3 === r5 && (t5 = normalize(n4[4].value, 100, 0, 1)), [e2.Number, t5.toString(), n4[2], n4[3], { value: t5, type: n.Number }];
  }
  if (n4[0] === e2.Number) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasNumberValues);
    let t5 = normalize(n4[4].value, 1, 0, 100);
    return 1 === r5 || 2 === r5 ? t5 = normalize(n4[4].value, 1, -1 / 0, 1 / 0) : 3 === r5 && (t5 = normalize(n4[4].value, 1, 0, 1)), [e2.Number, t5.toString(), n4[2], n4[3], { value: t5, type: n.Number }];
  }
  return false;
}
function lab(e4, a3) {
...
function normalize_LCH_ChannelValues(n4, r5, o5) {
  ...
  if (n4[0] === e2.Percentage) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasPercentageValues);
    let t5 = normalize(n4[4].value, 1, 0, 100);
    return 1 === r5 ? t5 = normalize(n4[4].value, 100 / 150, 0, 1 / 0) : 3 === r5 && (t5 = normalize(n4[4].value, 100, 0, 1)), [e2.Number, t5.toString(), n4[2], n4[3], { value: t5, type: n.Number }];
  }
  if (n4[0] === e2.Number) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasNumberValues);
    let t5 = normalize(n4[4].value, 1, 0, 100);
    return 1 === r5 ? t5 = normalize(n4[4].value, 1, 0, 1 / 0) : 3 === r5 && (t5 = normalize(n4[4].value, 1, 0, 1)), [e2.Number, t5.toString(), n4[2], n4[3], { value: t5, type: n.Number }];
  }
  return false;
}
function lch(e4, a3) {
...
function normalize_OKLab_ChannelValues(n4, r5, o5) {
  ...
  if (n4[0] === e2.Percentage) {
    ...
    return 1 === r5 || 2 === r5 ? t5 = normalize(n4[4].value, 250, -1 / 0, 1 / 0) : 3 === r5 && (t5 = normalize(n4[4].value, 100, 0, 1)), [e2.Number, t5.toString(), n4[2], n4[3], { value: t5, type: n.Number }];
  }
  if (n4[0] === e2.Number) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasNumberValues);
...
function normalize_OKLCH_ChannelValues(n4, r5, o5) {
  ...
  if (n4[0] === e2.Percentage) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasPercentageValues);
    let t5 = normalize(n4[4].value, 100, 0, 1);
    return 1 === r5 ? t5 = normalize(n4[4].value, 250, 0, 1 / 0) : 3 === r5 && (t5 = normalize(n4[4].value, 100, 0, 1)), [e2.Number, t5.toString(), n4[2], n4[3], { value: t5, type: n.Number }];
  }
  if (n4[0] === e2.Number) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasNumberValues);
    let t5 = normalize(n4[4].value, 1, 0, 1);
...
function normalize_legacy_sRGB_ChannelValues(n4, r5, o5) {
  if (n4[0] === e2.Percentage) {
    ...
    return [e2.Number, t5.toString(), n4[2], n4[3], { value: t5, type: n.Number }];
  }
  if (n4[0] === e2.Number) {
    3 !== r5 && o5.syntaxFlags.add(ae.HasNumberValues);
...
function serializeRGB(n4, r5 = true) {
  ...
  const t5 = Math.min(255, Math.max(0, Math.round(255 * toPrecision(o5[0])))), l2 = Math.min(255, Math.max(0, Math.round(255 * toPrecision(o5[1])))), s2 = Math.min(255, Math.max(0, Math.round(255 * toPrecision(o5[2])))), u3 = [e2.CloseParen, ")", -1, -1, void 0], i5 = [e2.Whitespace, " ", -1, -1, void 0], c2 = [e2.Comma, ",", -1, -1, void 0], m2 = [new TokenNode([e2.Number, t5.toString(), -1, -1, { value: o5[0], type: n.Integer }]), new TokenNode(c2), new WhitespaceNode([i5]), new TokenNode([e2.Number, l2.toString(), -1, -1, { value: o5[1], type: n.Integer }]), new TokenNode(c2), new WhitespaceNode([i5]), new TokenNode([e2.Number, s2.toString(), -1, -1, { value: o5[2], type: n.Integer }])];
  if ("number" == typeof n4.alpha) {
    const r6 = Math.min(1, Math.max(0, toPrecision(Number.isNaN(n4.alpha) ? 0 : n4.alpha)));
    return 1 === toPrecision(r6, 4) ? new FunctionNode([e2.Function, "rgb(", -1, -1, { value: "rgb" }], u3, m2) : new FunctionNode([e2.Function, "rgba(", -1, -1, { value: "rgba" }], u3, [...m2, new TokenNode(c2), new WhitespaceNode([i5]), new TokenNode([e2.Number, toPrecision(r6, 4).toString(), -1, -1, { value: n4.alpha, type: n.Number }])]);
  }
  return new FunctionNode([e2.Function, "rgba(", -1, -1, { value: "rgba" }], u3, [...m2, new TokenNode(c2), new WhitespaceNode([i5]), n4.alpha]);
}
function serializeHSL(n4, r5 = true) {
  ...
  const t5 = Math.min(360, Math.max(0, Math.round(toPrecision(o5[0])))), l2 = Math.min(100, Math.max(0, Math.round(toPrecision(o5[1])))), s2 = Math.min(100, Math.max(0, Math.round(toPrecision(o5[2])))), u3 = [e2.CloseParen, ")", -1, -1, void 0], c2 = [e2.Whitespace, " ", -1, -1, void 0], m2 = [e2.Comma, ",", -1, -1, void 0], h3 = [new TokenNode([e2.Number, t5.toString(), -1, -1, { value: o5[0], type: n.Integer }]), new TokenNode(m2), new WhitespaceNode([c2]), new TokenNode([e2.Percentage, l2.toString() + "%", -1, -1, { value: o5[1] }]), new TokenNode(m2), new WhitespaceNode([c2]), new TokenNode([e2.Percentage, s2.toString() + "%", -1, -1, { value: o5[2] }])];
  if ("number" == typeof n4.alpha) {
    const r6 = Math.min(1, Math.max(0, toPrecision(Number.isNaN(n4.alpha) ? 0 : n4.alpha)));
    return 1 === toPrecision(r6, 4) ? new FunctionNode([e2.Function, "hsl(", -1, -1, { value: "hsl" }], u3, h3) : new FunctionNode([e2.Function, "hsla(", -1, -1, { value: "hsla" }], u3, [...h3, new TokenNode(m2), new WhitespaceNode([c2]), new TokenNode([e2.Number, toPrecision(r6, 4).toString(), -1, -1, { value: n4.alpha, type: n.Number }])]);
  }
  return new FunctionNode([e2.Function, "hsla(", -1, -1, { value: "hsla" }], u3, [...h3, new TokenNode(m2), new WhitespaceNode([c2]), n4.alpha]);
}
function color(a3) {
...
var Tailwind = ({
  ...
  const markup = renderToString(/* @__PURE__ */ React5.createElement(React5.Fragment, null, children));
  const classNamesList = (markup.match(/class="([^"]*)"/g) || []).map((match) => {
  ...
  if (corePlugins2 && Array.isArray(corePlugins2)) {
    showPreflight = corePlugins2.includes("preflight");
  } else if (corePlugins2 && typeof corePlugins2 === "object") {
    showPreflight = corePlugins2.preflight === false ? false : true;
  }
  const { css } = postcss_default([
    ...
    String.raw`
        ...
        ${showPreflight ? preflight_default : ""}
      `,
    {
      from: void 0
    }
  );
  return /* @__PURE__ */ React5.createElement(React5.Fragment, null, /* @__PURE__ */ React5.createElement(CSS, null, css), children);
};
...
var compile = async (node, options) => {
  ...
  let Element = /* @__PURE__ */ React6.createElement(React6.Fragment, null, /* @__PURE__ */ React6.createElement(CSS, null, dist_default), node);
  if (!emotion) {
  ...
  Element = /* @__PURE__ */ React6.createElement(CacheProvider, { value: cache2 }, Element);
...
var Markdown = (props) => {
  ...
  const detectHeader = (child) => {
    if (!child)
      return;
    if (isReactElement(child) && typeof child.type === "string" && ["h1", "h2", "h3", "h4", "h5", "h6"].includes(child.type)) {
      headers.push({
        heading: child.type,
  ...
  const Toc = !!tocRenderer ? /* @__PURE__ */ React7.createElement(React7.Fragment, null, headers.map((header) => tocRenderer(header))) : null;
  return compiler(
    props.children,
...
var Latex = ({ children }) => {
  ...
  ), /* @__PURE__ */ React8.createElement("span", { dangerouslySetInnerHTML: { __html: html } }));
};
var __docConfig3 = {
  name: "LaTeX",
    ...
    Latex: {
      ...
      examples: {
        default: {
          ...
          template: /* @__PURE__ */ React8.createElement(Latex, null, String.raw`\frac{1}{2}`)
        },
        complex: {
          description: "Write complex LaTeX formulas in your document.",
          template: /* @__PURE__ */ React8.createElement(Latex, null, String.raw`% \f is defined as #1f(#2) using the macro
